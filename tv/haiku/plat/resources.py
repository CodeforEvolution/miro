...
RESOURCE_ROOT = os.path.abspath(
    os.environ.get('MIRO_RESOURCE_ROOT', '/boot/system/non-packaged/data/miro/resources/'))
DATA_ROOT = os.path.abspath(
    os.environ.get('MIRO_DATA_ROOT', '/boot/system/non-packaged/data/'))
...
def theme_path(theme, relative_path):
    return os.path.join('/boot/system/non-packaged/data/miro/themes', theme, relative_path)
